...
def option():
    ...
    var=IntVar()
    radio1=Radiobutton(win,text='SIGNUP',value=0,variable=var,font=20,bg='black',fg='white')
    radio1.place(x=350,y=140)
    radio2=Radiobutton(win,text='LOGIN',value=1,variable=var,font=20,bg='black',fg='white')
    radio2.place(x=350,y=210)
